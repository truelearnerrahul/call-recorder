...
//
///**
// * InCallActivity: improved audio handling for mute/speaker and UI state.
// *
// * Make sure layout contains views with IDs:
// *  - txtNumber (TextView)
// *  - btnAnswer (Button)
// *  - btnReject  (Button)
...
// *  - btnDialPad (ImageButton)
// *  - btnRecord (ImageButton)
// */
...
//        }
//
//        // Register call callback to react to state changes
//        if (currentCall != null) {
...
//                            // call became active: enable controls and configure audio
//                            setupAudioForCall();
...
//                            // ringing state - keep answer/reject visible
...
//        });
//
//        // Mute toggle: prefer Call.setMuted if available
...
//        });
//
//        // Speaker toggle: set audio mode and route
//        btnSpeaker.setOnClickListener(v -> {
//            isSpeakerOn = !isSpeakerOn;
//            MyInCallService callService = MyInCallService.getInstance(); // store reference when service starts
//            if (callService != null) {
...
//
//
//        // Dialpad placeholder - send a single DTMF (example '1'); ideally show keypad UI
...
//            if (isRecording) {
//                // TODO: start recording service / send command to recorder
//                btnRecord.setAlpha(0.5f);
//                Toast.makeText(this, "Recording started (placeholder)", Toast.LENGTH_SHORT).show();
//            } else {
//                // TODO: stop recording
//                btnRecord.setAlpha(1.0f);
//                Toast.makeText(this, "Recording stopped (placeholder)", Toast.LENGTH_SHORT).show();
//            }
//        });
//    }
//
//    /**
//     * Prepare audio environment for an active in-call session:
//     * - save previous mode/speaker
//     * - request audio focus
...
//            // ensure microphone not muted initially
//            audioManager.setMicrophoneMute(false);
//            // ensure speaker default off (user may toggle)
...
//
//    /**
//     * Restore audio environment back to previous state.
//     */
